...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">DANH SÁCH MODULES</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
		...
		<table class="table table-bordered">
			...
			while($rows = $objmysql->Fetch_Assoc()){ 
				...
				<tr>
					...
					<td align='center'><input type="checkbox" name="chk" value="<?php echo $rows['id'];?>" onclick="docheckonce('chk');" /></td>
					...
					<td align='center' width='10'><a href='<?php echo ROOTHOST_ADMIN.COMS.'/active/'.$ids;?>'><?php echo $icon_active; ?></a></td>

					<td align='center' width='10'><a href='<?php echo ROOTHOST_ADMIN.COMS.'/edit/'.$ids;?>'><i class='fa fa-edit' aria-hidden='true'></i></a></td>
				</tr>
