...
$sql_count = "SELECT COUNT(*) AS count FROM tbl_country WHERE 1=1 ".$strwhere;
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">DANH SÁCH QUỐC GIA</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM tbl_country WHERE 1=1 $strwhere ORDER BY `order` ASC LIMIT $star,".$max_rows;
                    $objmysql->Query($sql);
                    $i = 0;
