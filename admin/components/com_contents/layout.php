...
if(isset($_POST["cmdsave"])){
	...
	if(isset($_POST['txtid'])){
		...
		$objmysql->Exec("BEGIN");
		$sql = "INSERT INTO tbl_contents (`category_id`, `code`, `thumb`, `cdate`, `author`,
		`ishot`, `isactive`, `title`, `intro`, `fulltext`) 
		VALUES('".$CategoryID."', '".$Code."', '".$Thumb."', '".$Cdate."', '".$Author."', '".$isHot."',
		'".$isActive."', '".$Title."', '".$Intro."', '".$Fulltext."')";
		$result = $objmysql->Exec($sql); 
