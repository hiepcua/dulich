...
// id: DOM id
// str_array_ids: json_encode_array_id
function cbo_SelectedInArray(id, str_array_ids)
{
	// Convert string to array
	var arr_ids = JSON.parse(str_array_ids);
	var str_id = arr_ids.toString();
	$.each(str_id.split(","), function(i,e){
