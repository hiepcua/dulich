...
class CLS_WARD{
	...
	public function getListCbo($id=0,$city_id=0,$dist_id=0){
		$sql="SELECT * FROM `tbl_ward` WHERE 1=1 ";
		if($city_id!=0) $sql.=" AND city_id=$city_id";
		if($dist_id!=0) $sql.=" AND district_id=$dist_id";
